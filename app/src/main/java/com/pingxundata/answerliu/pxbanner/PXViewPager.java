...
public class PXViewPager extends ViewPager {
    private boolean mAllowUserScrollable = true;
    private AutoPlayDelegate mAutoPlayDelegate;

    public PXViewPager(Context context) {
        super(context);
    }

    public PXViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setPageChangeDuration(int duration) {
        try {
            ...
            scrollerField.set(this, new PXBannerScroller(getContext(), duration));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
